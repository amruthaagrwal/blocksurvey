...
export const questions = [
    ...
    { id: 11, text: "I lead meetings well." },
    { id: 12, text: "I take care of my physical health." },
    { id: 13, text: "I regularly seek feedback from others about quality of my life." },
    { id: 14, text: "If I asked I would be able to describe what I want to do with my life." },
    ...
    { id: 28, text: "I bring in more creative ideas to the team." },
    ...
    { id: 36, text: "Whenever possible I try to measure my achievements with data and facts." },
    ...
    { id: 76, text: "I allow opportunities for the development of my subordinates." },
    ...
    { id: 105, text: "At times I value unconventional approaches at work." },
