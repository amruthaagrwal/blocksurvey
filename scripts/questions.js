...
export const questions = [
    ...
    { id: 8, text: "I understand the principles that underlie my approach to managing others." },
    ...
    { id: 20, text: "I have the full support of my subordinates." },
    ...
    { id: 23, text: "I am prepared to be unpopular when necessary." },
    ...
    { id: 26, text: "My working life is often exciting." },
    ...
    { id: 68, text: "I almost always act in ways which are consistent with my personal beliefs." },
    ...
    { id: 104, text: "I do not have more or bigger problems today than I had a year ago." },
